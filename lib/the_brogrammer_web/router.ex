defmodule TheBrogrammerWeb.Router do
  use TheBrogrammerWeb, :router
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: TheBrogrammerWeb.Telemetry
